...
iptables -t nat -A PREROUTING -p udp -m udp -d 10.0.0.1 --dport 53 -m mark --mark 0x3 -j DNAT --to-destination 10.1.3.3:53
iptables -t nat -A PREROUTING -p tcp -m tcp -d 10.0.0.1 --dport 53 -m mark --mark 0x3 -j DNAT --to-destination 10.1.3.3:53
iptables -t nat -A PREROUTING -p udp -m udp -d 10.0.0.1 --dport 53 -m mark --mark 0x2 -j DNAT --to-destination 10.1.2.3:53
iptables -t nat -A PREROUTING -p tcp -m tcp -d 10.0.0.1 --dport 53 -m mark --mark 0x2 -j DNAT --to-destination 10.1.2.3:53
